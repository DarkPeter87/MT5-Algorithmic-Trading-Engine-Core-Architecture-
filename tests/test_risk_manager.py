...
def test_risk_manager_fallback():
    ...
    params = rm.calculate(
        balance=1000, current_price=2000.0, atr=0.0, is_buy=True, 
        tick_value=10.0, tick_size=0.1, volume_min=0.01, volume_max=10.0, volume_step=0.01
    )
...
def test_risk_manager_lot_calculation():
    ...
    params = rm.calculate(
        balance=1000, current_price=2000.0, atr=3.3333333, is_buy=True, 
        tick_value=10.0, tick_size=0.1, volume_min=0.01, volume_max=10.0, volume_step=0.01
    )
